...
namespace ServicioCondiciones
{
    ...
    public interface IServicioClausulas
    {
        ...
        string ObtenerCondicionesXml(string Pais, string Producto, string Tarifa, string Usuario, string Clave);
        ...
        string ObtenerDocumentosXml(int CodigoPais, string Codigo, string Usuario, string Clave);

        string ObtenerDocumentosXml(int CodigoPais, string Usuario, string Clave);

        string ConvertirConsulta(ConsultaCondicionesDTO Consulta);

        string ConvertirGrupos(GruposClausulaDTO Grupos);

        GrupoClausulaDTO ObtenerCondiciones(string CodigoPais, string Producto, string Tarifa, int Edad);

        GrupoClausulaDTO ObtenerCondiciones(int CodigoPais, string Producto, string Tarifa, int Edad, bool Anual, int IdTipoPlan);

        string GetPrintedBenefits(string xml, string Usuario, string Clave);
    }
    ...
    public class GrupoClausulasImpresasDTO
    {
        public ClausulaImpresaDTO[] ClausulasImpresas { get; set; }
        public DocumentoDTO[] Documentos { get; set; }
        public string Estado { get; set; }

        public GrupoClausulasImpresasDTO() { }
    }

    public class ClausulaImpresaDTO
    {
        ...
        public ClausulaImpresaDTO(string codigo, string titulo, string contenido, string tipoClausula)
        {
            this.Codigo = codigo;
            this.Titulo = titulo;
