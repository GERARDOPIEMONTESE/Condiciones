...
public class ServicioConversionXml
{
    ...
    private String ISOByteArrayToString(Byte[] characters)
    {
        String constructedString = Encoding.GetEncoding("ISO-8859-1").GetString(characters);
        return (constructedString);
    }

    private Byte[] StringToISOByteArray(String pXmlString)
    {
        Byte[] byteArray = Encoding.GetEncoding("ISO-8859-1").GetBytes(pXmlString);
        return byteArray;
    }
    ...
    public String SerializeObjectISO(Object pObject)
    {
        try
        {
            ...
            XmlizedString = ISOByteArrayToString(memoryStream.ToArray());
