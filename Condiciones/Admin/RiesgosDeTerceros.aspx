                ...
                <td style="text-align: left;">
                    <table border="0" cellpadding="1" cellspacing="1">
                        <tr>
                            ...
                            <td class="btn-cntnr">
                                <asp:Button ID="BExcel" runat="server" Text="Exportar" OnClick="Excel_Click" CssClass="Button_Normal" />
                            </td>
                        </tr>
                    </table>
                </td>  
                ...
                <td align="center">
                    ...
                    <div style="text-align:left; overflow:auto ;height:650px; width:900px">
                        <cc1:GridKua ID="grvListaRiesgoTerceros" runat="server" AutoGenerateColumns ="False"
                            AllowPaging="True" Export="Yes" DataKeyNames="Id"
                            ...
                            OnRowDataBound="grvListaRiesgoTerceros_RowDataBound"
                            PagerType="DropDownList" ExportPDF="No" 
                            meta:resourcekey="grvListaRiesgoTercerosResource1">
                            <Columns>
                                <asp:BoundField HeaderText="Id" DataField="Id" meta:resourcekey="BoundFieldResource1" HeaderStyle-CssClass="hiddencol" ItemStyle-CssClass="hiddencol" ItemStyle-HorizontalAlign="Center" />
                        ...
                        <asp:Label ID="LblRiesgosEmpty" runat="server" CssClass="TextLegend_Normal" 
