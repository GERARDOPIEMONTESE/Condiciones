...
WHERE  IdLocacion IN(SELECT IdLocacion 
       ...
       AND P.Codigo IN ('3D','3E','3U','4A','4O','4P','5A','5B','5C','5D','5E','5F','5G','5I','5K','5L','5M','7C','7D') AND (T.Sufijo = '' OR T.Sufijo IS NULL) AND T.Activa = 1
...
INNER JOIN Condiciones.dbo.Producto P ON T.IdProducto = P.IdProducto 
	where 
       ...
       AND P.Codigo IN ('3D','3E','3U','4A','4O','4P','5A','5B','5C','5D','5E','5F','5G','5I','5K','5L','5M','7C','7D') 
