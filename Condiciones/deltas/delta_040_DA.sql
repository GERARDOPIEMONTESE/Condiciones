...
WHERE  IdLocacion IN(SELECT IdLocacion 
       ...
       AND P.Codigo IN ('6A','6B','6C','6D','6E','6F','6G','6I','6J','6L','6M','6N','6Q','6K','6R','XO','XP') AND (T.Sufijo = '' OR T.Sufijo IS NULL) AND T.Activa = 1
...
INNER JOIN Condiciones.dbo.Producto P ON T.IdProducto = P.IdProducto 
	where 
       ...
       AND P.Codigo IN ('6A','6B','6C','6D','6E','6F','6G','6I','6J','6L','6M','6N','6Q','6K','6R','XO','XP')
